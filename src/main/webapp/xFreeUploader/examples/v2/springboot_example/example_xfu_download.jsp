...
function init() {
	...
	if(top.document.getElementById("serverType")){
	
		strServerType = top.document.getElementById("serverType").value;
	}
	...
	wFileDownload = new xFreeUploader({
		...
		onDeleteFile: function (data) {
			...
			wFileDownload.emptyFolderDelete("/uploads");
		},
		// [항목전체제거] 버튼 클릭 이벤트핸들러
